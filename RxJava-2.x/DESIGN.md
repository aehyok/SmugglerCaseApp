...
Instead of the indirection of an `onSubscribe` and `lift`, operators are to be implemented by extending the base classes. For example, the `userDataMap`
...
```java
public final Flowable<R> userDataMap(Function<? super T, ? extends R> mapper) {
