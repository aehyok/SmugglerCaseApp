...
public class FinishApproveFragment extends Fragment {
    ...
    public void onResume() {
        ...
        if (ApplicationUtil.isIsLinkSubmit()) {
            documentApproveAdapter.clear();
            getData();
    ...
    private void getData() {
        ...
        if (!AppNetworkMgr.isNetworkConnected(getActivity())) {
            ...
            ObserverOnNextListener listener = new ObserverOnNextListener<List<Apporove>>() {
                ...
                public void onNext(List<Apporove> result) {
                    ...
                    if (result.size() != 0) {
                        ...
                        documentApproveAdapter.getData(result, 2);
                        refreshLayout.finishRefresh();
                    } else {
            ...
            NetMethods.getApprovalPended(new MyObserver<List<Apporove>>(getActivity(), listener), ApplicationUtil.getUserId());
