 ...
 * 文书审批列表Adapter
 */
public class LinkBackAdapter extends BaseAdapter {
    Context context;
    List<Apporove> mList = new ArrayList<>();
    int type;
    private ViewHolder holder;

    public LinkBackAdapter(Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        switch (type) {
            ...
            case 2://已审批
                ...
                holder.approveListTime.setText("呈请日期："+mList.get(i).getSPRQ());
                break;

        }
        holder.approveListTitle.setText("审批事项："+mList.get(i).getCSTATE());
