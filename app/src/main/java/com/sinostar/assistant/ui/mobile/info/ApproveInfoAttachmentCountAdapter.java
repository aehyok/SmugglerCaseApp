 ...
 * 随附材料列表Adapter
 */
public class ApproveInfoAttachmentCountAdapter extends BaseAdapter {
    Context context;
    List<Document.DYSXBean> mlist=new ArrayList<>();
    int type;

    ApproveInfoAttachmentCountAdapter(Context context){
        this.context=context;
    }
    public void getData(List<Document.DYSXBean> list,int type ){
        mlist.clear();
        this.mlist=list;
        this.type=type;
