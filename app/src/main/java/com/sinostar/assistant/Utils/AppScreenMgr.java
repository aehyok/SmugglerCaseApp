...
public class AppScreenMgr {
    ...
    public static int getRealScreenHeight(Context context) {
        int dpi = 0;
        Display display = ((AppCompatActivity) context).getWindowManager()
                .getDefaultDisplay();
     ...
     * @return 标题栏高度
     */
    public static int getTitleBarHeight(AppCompatActivity context) {
     ...
     * @return 保存的路径
     */
    public static String shoot(AppCompatActivity a) {
