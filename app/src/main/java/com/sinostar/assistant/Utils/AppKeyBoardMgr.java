...
public class AppKeyBoardMgr {
     ...
     * @param mAct activity
     */
    public static void hideInputMethod(AppCompatActivity mAct) {
     ...
     * @param mAct activity
     */
    public static void showInputMethod(final AppCompatActivity mAct) {
        View v = mAct.getCurrentFocus();
        if (null == v) {
            return;
        }
        ((InputMethodManager) mAct.getSystemService(AppCompatActivity.INPUT_METHOD_SERVICE)).showSoftInput(v, 0);
    }
}
