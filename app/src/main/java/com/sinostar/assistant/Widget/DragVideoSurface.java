 ...
 * 可拖拽视频
 */
public class DragVideoSurface extends TextureView {
    ...
    public DragVideoSurface(Context context) {
        this(context, null);
    }

    public DragVideoSurface(Context context, AttributeSet attr) {
        this(context, attr, 0);
    }

    public DragVideoSurface(Context context, AttributeSet attr, int defStyle) {
...
//    }
                            ...
                            public void run() {
                                if (mTranslateX == 0 && mTranslateY == 0 && canFinish) {
                                    ...
                                    if (mTapListener != null) {
                                        mTapListener.onTap(DragVideoSurface.this);
                                    }
                                }
                                canFinish = false;
                            }
    ...
    private void onActionMove(MotionEvent event) {
        ...
        mMoveListener.onMove( mTranslateX, mTranslateY, mScale);
        invalidate();
    }
    ...
    public void setOnTapListener(DragVideoSurface.OnTapListener listener) {
        mTapListener = listener;
    }

    public void setOnExitListener(DragVideoSurface.OnExitListener listener) {
        mExitListener = listener;
    }

    public interface OnTapListener {
        void onTap(DragVideoSurface view);
    }

    public interface OnExitListener {
        void onExit(DragVideoSurface view, float translateX, float translateY, float w, float h);
    }
    public interface OnMoveListener {
        void onMove(float translateX, float translateY, float mScale);
    }

    public void setOnMoveListener(DragVideoSurface.OnMoveListener listener) {
